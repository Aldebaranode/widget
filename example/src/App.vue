...
<template>
  <div>
    ...
    <ping-tx-dialog :type="toOpen" :sender="sender" :endpoint="endpoint" :params="params"></ping-tx-dialog>

    <br />
    // example:<br />
    <label for="withdraw" class="btn">Withdraw</label>
    <ping-tx-dialog type="withdraw" :sender="sender" :endpoint="endpoint" :params="params"></ping-tx-dialog>

    <label for="vote" class="btn">Vote</label>
    <ping-tx-dialog type="vote" :sender="sender" :endpoint="endpoint" :params="params"></ping-tx-dialog>
  </div>
</template>
